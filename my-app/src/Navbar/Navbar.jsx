  ...
  return (
    <nav className="w-full py-4 flex justify-between items-center bg-white fixed top-0 left-0 right-0 z-50">
      ...
      <div className="mt-auto mr-3 flex">
        <a
          className="block px-4 py-3 mb-2 leading-loose text-xs text-center font-semibold bg-gray-200 hover:bg-gray-100 rounded-xl"
          href="/login"
        >
          Sign in
        </a>
        <a
          className="block px-4 py-3 mb-2 leading-loose text-xs text-center font-semibold bg-blue-600 hover:bg-blue-700  rounded-xl"
          href="/register"
        >
          Sign Up
        </a>
